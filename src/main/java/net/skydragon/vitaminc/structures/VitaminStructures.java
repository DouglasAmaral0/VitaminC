package net.skydragon.vitaminc.structures;
...
import net.skydragon.vitaminc.VitaminST;

import java.util.Optional;

public class VitaminStructures extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<VitaminStructures> CODEC = RecordCodecBuilder.<VitaminStructures>mapCodec(instance ->
            instance.group(VitaminStructures.configCodecBuilder(instance),
            ...
            ).apply(instance, VitaminStructures::new)).codec();
    ...
    public VitaminStructures(Structure.Config config,
    ...
    public Optional<Structure.StructurePosition> getStructurePosition(Structure.Context context) {
        ...
        if (!VitaminStructures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> getType() {
        return VitaminST.VITAMIN_STRUCTURES; // Helps the game know how to turn this structure back to json to save to chunks
    }
}